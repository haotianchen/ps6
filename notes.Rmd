...
## Simple Linear Model
The simple linear model is a regression model with one predictor. We refer to the X as the **independent (The explanatory) variable** and Y as the **dependent (response)** variable.
